...
The dominant modal category is \textit{Life and Leisure} in the COW gold standard (panel a).
...
The confusion matrices in Table~\ref{tab:confusion} definitely illustrate, however, that topic domains are represented quite differently in newspaper and web corpora.
