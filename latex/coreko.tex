...
\title{Automatic Classification of Topic Domains for Meta Data Generation, Web Corpus Evaluation, and Corpus Comparison}
...
\newcite[PAGE]{BiberEgbert2016} report \textit{accuracy}=$XXX$, \textit{precision}=$XXX$, \textit{recall}=$XXX$.
