...
\includegraphics[width=0.25\textwidth]{graphics/fulogo}\hspace{0.05\textwidth}\includegraphics[width=0.10\textwidth]{graphics/dfglogo}\hspace{0.4
...
\begin{frame}
  ...
  \resizebox{0.33\textwidth}{!}{\begin{tabular}{|llcccccccc|}
   ...
   \multirow{8}{*}{\rot{\textbf{Annotated}}} & \textbf{PolSoc}  & \textbf{26} &  12 &  10 &   1 &   1 &   0 &   1 &   0 \\ 
     ...
     \hline
 \end{tabular}}
%~~\resizebox{0.25\textwidth}{!}{\begin{tabular}{|llcccccc|}
%    \hline
